...
class AttractionDetailFragment :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.attraction.observe(viewLifecycleOwner, attractionObserver())
    ...
    private fun attractionObserver(): (t: AttractionModelV) -> Unit = {
        binding.attraction = it

        settingCarousel(it)
    }

    private fun settingCarousel(it: AttractionModelV) {
    ...
    private fun settingUrlTextView() {
